"use strict";
let guestList = ["Albert Einstein", "Leonardo da Vinci", "Isaac Newton", "Nelson Mandela", "Ada Lovelace", "Galileo Galilei"];
const maxGuests = 2;
...
const numInvited = guestList.length;
console.log("Number of people invited to dinner:", numInvited);
